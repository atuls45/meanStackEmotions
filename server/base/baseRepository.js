...
class BaseRepository {
    ...
    /**
     * Invokes the specified `query` on this repository's `connection`.
     * @returns {Object[]} result of query execution.
     */
    async runQuery(query) {
        return await query.exec();
    }

    //Define own flavours and query helper to make queries more user friendly.
}
